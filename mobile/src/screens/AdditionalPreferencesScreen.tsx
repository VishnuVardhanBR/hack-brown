...
interface AdditionalPreferencesScreenProps {
    navigation: any;
    route: any;
}
...
export const AdditionalPreferencesScreen: React.FC<AdditionalPreferencesScreenProps> = ({ navigation, route }) => {
    ...
    const handleNext = () => {
        // Combine selected preferences labels with additional text
        const combinedPreferences = [selectedPreferences, preferences]
            .filter(Boolean)
            .join('. ');
                ...
                >
                    ...
                    <Animated.View style={[styles.exampleContainer, { opacity: fadeAnim }]}>
                        <View style={styles.exampleBubble}>
                            <Text style={styles.exampleText}>example: Vegan, wheelchair accessible</Text>
                        </View>
                    </Animated.View>
...
export default AdditionalPreferencesScreen;
